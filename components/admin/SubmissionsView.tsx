  ...
  const actions = (
    <>
      ...
      <button
        ...
        className="flex items-center px-4 py-2 text-sm bg-brand-primary text-white font-semibold rounded-lg shadow-md hover:bg-brand-secondary transition-colors"
      >
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white">
            ...
            <tbody className="text-gray-700">
              {submissions.map(sub => {
                const option = form.options?.find(
