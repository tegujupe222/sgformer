...
export const GoogleIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 48 48">
    <path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039L38.397 7.618C34.311 4.026 29.471 2 24 2C11.82 2 2 11.82 2 24s9.82 22 22 22s22-9.82 22-22c0-1.341-.138-2.65-.389-3.917z"></path>
    <path fill="#FF3D00" d="M6.306 14.691c-1.218 2.228-1.921 4.764-1.921 7.494s.703 5.266 1.921 7.494l5.81-4.576C11.536 24.52 11 23.313 11 22s.536-2.52 1.116-3.424L6.306 14.691z"></path>
    <path fill="#4CAF50" d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-4.82c-2.022 1.63-4.733 2.61-7.219 2.61c-4.411 0-8.4-2.658-10.141-6.484l-5.84 4.568C7.163 38.312 14.91 44 24 44z"></path>
    <path fill="#1976D2" d="M43.611 20.083H24v8h11.303c-0.792 2.237-2.231 4.166-4.087 5.571l6.19 4.82C39.73 34.806 42 30.022 42 24c0-2.324-.349-4.549-.961-6.638L34.303 20H42v.083z"></path>
  </svg>
);
